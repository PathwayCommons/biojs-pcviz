...
@class biojspcviz
 */
var biojspcviz = function() {
	var loaded = false;
	
	this.getWidget = function(networkType) {
	...
	this.populateEl = function(iframe) {
	...
	this.graphQuery = function(type, opts) {
	...
	this.neighborhood = function(opts) {
		return this.graphQuery("neighborhood", opts);
	};

	this.pathsbetween = function(opts) {
