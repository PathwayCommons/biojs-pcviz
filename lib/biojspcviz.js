...
var biojspcviz = {
	...
	getWidget: function(networkType) {
	...
	neighborhood: function(opts) {
		return this.graphQuery("neighborhood", opts);
	},

	pathsbetween: function(opts) {
...
module.exports = function() {
	return _.extend(this, biojspcviz);
};